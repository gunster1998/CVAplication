...
const ExperienceList = ({ register, errors }) => {
    ...
    const experienceList = experience.map((item, index) => (_jsxs("div", { children: [_jsxs("div", { className: styles.inputSeparator, children: [_jsx(InputUx, { maxLength: 15, value: item.Company, "data-id": item.id, label: '\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0438', ...register(`Experience.${index}.Company`, {
                            onChange: (e) => {
